...
#ifndef RTE_FLASH0_BASE
  #define MRAM_BASE_NS  0x0A000000
  #define MRAM_BASE_S   0x1A000000
  #if RTE_FLASH0_SECURE
    #define RTE_FLASH0_BASE   MRAM_BASE_S
  #else
    #define RTE_FLASH0_BASE   MRAM_BASE_NS
  #endif
#endif
...
static ARM_FLASH_INFO ARM_FLASH0_DEV_DATA = {
    ...
    .sector_count = RTE_FLASH0_SIZE / RTE_FLASH0_SECTOR_SIZE,
    .sector_size  = RTE_FLASH0_SECTOR_SIZE,
    .page_size    = RTE_FLASH0_PAGE_SIZE,
    .program_unit = RTE_FLASH0_PROGRAM_UNIT,
    .erased_value = ARM_FLASH_DRV_ERASE_VALUE};

static struct arm_flash_dev_t ARM_FLASH0_DEV = {
    .memory_base = RTE_FLASH0_BASE+RTE_FLASH0_BASE_OFFSET,
